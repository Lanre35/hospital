                                    ...
                                    <div class="row">
                                        <div class="col-md-5">
                                            <div class="profile-info-left">
                                                <h3 class="user-name m-t-0 mb-0">{{ $find->firstname }} {{ $find->lastname }}</h3>
                                                <small class="text-muted">{{ $find->biography }}</small>
                                        ...
                                        <div class="col-md-7">
                                            <ul class="personal-info">
                                                <li>
                                                    ...
                                                    <span class="text"><a href="#">{{ $find->phone }}</a></span>
                                                </li>
                                                <li>
                                                    <span class="title">Email:</span>
                                                    <span class="text"><a href="#">{{ $find->email }}</a></span>
                                                </li>
                                                <li>
                                                    <span class="title">Birthday:</span>
                                                    <span class="text">{{ $find->dateofbirth }}</span>
                                                </li>
                                                {{-- <li>
                                                ...
                                                <li>
                                                    ...
                                                    <span class="text">{{ $find->gender }}</span>
                                                </li>
                                            </ul>
                                        </div>
                                    </div>
