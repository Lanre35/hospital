                    ...
                    <div class="col-lg-8 offset-lg-2">
                        <form action="{{ route('departments.update', [$department->id]) }}" method="post">
                            ...
                            <div class="form-group">
                                ...
                                <input name="department" class="form-control" type="text" value="{{ $department->department }}">
                            </div>
                            <div class="form-group">
                                <label>Description</label>
                                <textarea name="description" cols="30" rows="4" class="form-control">{{ $department->description }}</textarea>
                            </div>
                            <div class="form-group">
