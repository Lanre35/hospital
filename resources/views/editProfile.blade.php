                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="form-group form-focus">
                                            ...
                                            <input name="firstname" type="text" class="form-control floating" value="{{ $editProfile->firstname }}">
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="form-group form-focus">
                                            <label class="focus-label">Last Name</label>
                                            <input name="lastname" type="text" class="form-control floating" value="{{ $editProfile->lastname }}">
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="form-group form-focus">
                                            ...
                                            <div class="cal-icon">
                                                <input name="dateofbirth" class="form-control floating datetimepicker" type="text"
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group form-focus select-focus">
                                            ...
                                            <select name="gender" class="select form-control floating">
                                                <option value="{{ $editProfile->gender }}">{{ $editProfile->gender }}</option>
