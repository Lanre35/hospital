...
<div class="page-wrapper">
        ...
        <div class="row">
            ...
            <div class="col-sm-4 col-7 text-right m-b-30">
                <a href="{{ route('leave-type.create') }}" class="btn btn-primary btn-rounded float-right"><i
                        ...
                        <tbody>
                            ...
                            <td class="text-right">
                                <div class="dropdown dropdown-action">
                                    ...
                                    <div class="dropdown-menu dropdown-menu-right">
                                        <a class="dropdown-item" href="{{ route('leave-type.edit', [$lt->id]) }}"><i
